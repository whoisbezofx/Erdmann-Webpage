...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden min-h-[600px] md:min-h-[700px]">
      ...
      <div className="container relative mx-auto px-4 md:px-6 py-24 md:py-36 lg:py-44">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-16">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                href="tel:+4950336063"
                className="text-base inline-flex shrink-0 items-center justify-center rounded-lg h-9 gap-1.5 px-2.5 text-sm font-medium border border-white/30 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20 transition-colors"
              >
          ...
          {/* Logo – right column, desktop only */}
